...
export default function TonePage() {
  return (
    <div className="min-h-screen bg-[url('/gameplay2.jpg')] bg-cover bg-right lg:bg-center  md:bg-left-bottom  bg-[rgba(0,0,0,0.2)] bg-blend-multiply bg-no-repeat flex items-center justify-end p-10 pr-0 lg:pr-60 md:pr-30">
