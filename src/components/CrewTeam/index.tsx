                        ...
                        <div key={index} className="relative z-50" >
                            ...
                            <div className="flex flex-wrap justify-center items-center gap-8">
                                {category.members.map((member, memberIndex) => (
                                    ...
                                    <div
                                        key={memberIndex} className="w-[200px] flex flex-col justify-center items-center hover:scale-105 transition rounded-lg shadow-lg text-xs whitespace-nowrap text-center p-8 mb-2 ">
                                        ...
                                        <h3 className="font-medium text-m text-white py-4">{member.name}</h3>
